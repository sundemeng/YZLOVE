...
if($_REQUEST['submitok']=="delupdate"){
  ...
  echo "<script language=\"javascript\">alert('驳回成功！');window.location.href='user_jb_list.php?p=".$p."";
  echo "'</script>";
  exit();
...
elseif($_REQUEST['submitok']=="allupdate"){
		...
		echo "<script language=\"javascript\">alert('审核成功！');window.location.href='user_jb_list.php?p=".$p."";
		echo $kinds;
		echo "'</script>";
		exit();
}
  ...
  <tr>
    <td width="20%" align="left"><table width="157" height="17" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="130" style="font-size:10.3pt;padding-top:3px;"><b>基本资料审核:</b></td>
      </tr>
    </table></td>
...
<table width="98%" height="29" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" >
   <tr bgcolor="#FFFFFF">
    ...
    <td width="242" align="center" valign="bottom" bgcolor="D3DCE3"><font color="#000000"><b>自我介绍</b></font></td>
...
<b><font color=red>注册时间：<?php echo $rows['regtime']; ?></b><br>
      <font color="#999999">最后登录：<?php echo $rows['logintime']; ?></font></td>
      <td valign="top" style="line-height:150%;">
　<a href="../login.php?submitok=checkuseradmin&uid=<?php echo $rows['id']; ?>&pwd=<?php echo $rows['password']; ?>&tmpurl=a2.php" target="_blank"title="点击直接进入管理" class="uFF5494" >进入管理</a></td>
