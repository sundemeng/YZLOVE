...
if($_REQUEST['submitok']=="allupdate"){
		...
		echo "<script language=\"javascript\">alert('删除成功！');window.location.href='supphoto_search.php'</script>";
		exit();
}
...
?>
		...
		<table width="140" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:#dddddd 1px solid;">
          <tr>
			...
			<img src=../up/wzphoto/<?php echo $rows['path_b']; ?> alt="放大照片" border="0"></a></td>
          </tr>
          <tr>
          ...
          <tr>
             <td colspan="2" bgcolor="#efefef" bgcolor=#ffffff align=center>发布时间：<font color="#FF0000"><u><?php echo date_format2($rows['addtime'],'%Y年%m月%d日 %H时%M分');?></u></font></td>
          <tr>
