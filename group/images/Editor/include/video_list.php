...
function emott2(str1,str2) {
	var str;
	var str1;
	var str2;
str = "<object classid=clsid:D27CDB6E-AE6D-11cf-96B8-444553540000 codebase=http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0 width=440 height=384><param name=movie value=<?php echo $Global['www_2domain'];?>/images/mainplayer.swf?flvname=<?php echo $Global['up_2domain'];?>/<?php echo $Global['m_flvpath'];?>/"+str1+"&"+"videotitle="+str2+"><param name=quality value=high><embed src=<?php echo $Global['www_2domain'];?>/images/mainplayer.swf quality=high pluginspage=http://www.macromedia.com/go/getflashplayer type=application/x-shockwave-flash width=440 height=384></embed></object>";
...
<table width="540" height="33" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="311" align="center"><img src="../../tips3.gif" width="11" height="15" hspace="5" align="absmiddle"><b><font color="6699CC">请选择视频</font></b></td>
    <td width="106" align="center">&nbsp;</td>
  </tr>
</table>
<?php
$rt=$db->query("SELECT * FROM ".__TBL_VEDIO__." WHERE userid='$cook_userid' AND kind='$photokind' AND flag=1 ORDER BY id DESC");
