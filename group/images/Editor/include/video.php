...
<table width="200" height="33" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center"><img src="../../tips3.gif" width="11" height="15" hspace="5" align="absmiddle"><b><font color="6699CC">请选择视频目录</font></b></td>
  </tr>
</table>
<?php
$rt = $db->query("SELECT * FROM ".__TBL_VEDIO_KIND__." WHERE userid='$cook_userid' ORDER BY px,id");
...
<table width="540" border="0" align="center" cellpadding="3" cellspacing="0" bgcolor="EDF8FF" style="border:#B0D5F3 1px solid;">
  <tr>
	...
	if(!$rows) break;
	$rtmail = $db->query("SELECT COUNT(id) FROM ".__TBL_VEDIO__." WHERE userid='$cook_userid' AND kind='".$rows['id']."'");
...
?>
    <td align="center" style="padding-top:20px;padding-bottom:20px;"><table width="130" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" style="font-size:10.3pt;"><a href="video_list.php?photokind=<?php echo $rows['id'] ?>" target="testwin"><img src="<?php echo $Global['www_2domain']; ?>/images/photoroot.gif" width="37" height="30" hspace="5" vspace="5" border="0" align="absmiddle"><?php echo $rows['title'] ?></a></td>
      </tr>
      <tr>
        <td height="25" align="center" style="color:#999999;">共有<font color="#FF0000" style="font-size:9pt;color:#red"><?php echo $photocount; ?></font>个视频</td>
      </tr>
    </table></td>
    <?php if ($i % 3 == 0) {?>
  </tr>
...
<br>
  <?php 
	...
	echo "<br><br>...你的相册中没有视频，请返回个人管理中心用摄像头录制！...";
}?>
