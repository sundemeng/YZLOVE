...
//插入图片
function image(){
	var arr = showModalDialog("../sub/Editor/include/img.htm", window, "dialogWidth:600px; dialogHeight:250px;status:0;help:0;scroll:0;");
	if (arr)
	{
...
//插入Flash
function flash(){
	var arr = showModalDialog("../sub/Editor/include/swf.htm", "", "dialogWidth:400px; dialogHeight:180px; status:0; help:0");
	if (arr != null)
	{
		var ss;
		ss=arr.split("*");
...
//插入 MediaPlayer 播放器
function wmv(){
	var arr = showModalDialog("../sub/Editor/include/wmv.htm", window, "dialogWidth:400px; dialogHeight:240px; status:0;help:0;scroll:0;");
	if (arr != null)
	{
		var ss;
		ss=arr.split("*");
...
//插入 RealPlayer 播放器
function rm(){
	var arr = showModalDialog("../sub/Editor/include/rm.htm", window, "dialogWidth:400px; dialogHeight:220px; status:0; help:0");
	if (arr != null)
	{
		var ss;
		ss=arr.split("*");
...
*/
function FontColor(){
	var arr = showModalDialog("../sub/Editor/include/selcolor.htm", window, "dialogWidth:300px; dialogHeight:300px; status:0; help:0");
	if (arr)
	{
		var sText = oEditor.document.selection.createRange();
		if(sText){
...
function fh(){
	var arr = showModalDialog("../sub/Editor/include/emot.htm", window, "dialogWidth:310px; dialogHeight:225px;status:0;help:0;scroll:0;");
	if (arr)
	{
		oEditor.document.body.innerHTML+=arr;
	}
