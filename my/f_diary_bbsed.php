...
<li class="liselect"><a href="f_diary_bbsed.php">我的评论</a></li>
...
<div class="main2_frame">
  <?php
//列表程序开始
	$rt=$db->query("SELECT id,fid,content,addtime FROM ".__TBL_DIARY_BBS__." WHERE userid=".$cook_userid." ORDER BY id DESC");
...
?>
  ...
  <table width="650" border="0" align="center" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td width="499" height="30" align="center" valign="middle" style="border-bottom:#ddd 1px solid">评 论 过 的 日 记</td>
      <td width="147" align="center" valign="middle" style="border-bottom:#ddd 1px solid">评论时间</td>
    </tr>
    <?php
...
?>
    <tr <?php echo $bg;?> onmouseover="this.style.background='<?php echo $overbg; ?>'" onmouseout="this.style.background='<?php echo $outbg; ?>'" >
      <td height="35" style="border-bottom:#E9E8E8 1px solid;line-height:150%"><a href="<?php echo $Global['home_2domain']."/diary".$rows['fid'].".html"; ?>" target="_blank" class="666666"><img src="images/zoom.gif" alt="查看详细" hspace="5" border="0" align="absmiddle" /><?php echo htmlout(stripslashes($rows['content'])); ?></a></td>
