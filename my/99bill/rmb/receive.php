	...
	switch($payResult){
		  case "10":
			...
			*/
			...
			$rtnOk=1;
			$rtnUrl=$Global['my_2domain']."/99bill/rmb/show.php?msg=支付成功，请关闭浏览器，退出重新登录本站！!";
			break;
		  default:
			$rtnOk=1;
			$rtnUrl=$Global['my_2domain']."/99bill/rmb/show.php?msg=支付失败!";
			break;
	}
}else{
	$rtnOk=1;
	$rtnUrl=$Global['my_2domain']."/99bill/rmb/show.php?msg=出错!";
} 
